...
contract Haddy {
   ...
   constructor() public {
    ...
    /**
     * @dev Allows the current owner to transfer control of the contract to a newOwner.Modifier is like a roadblock check.  mnbv .
...
contract Haddy is Ownable,IERC20 {
    ...
    modifier timeStop{
        require(_totalSupply<totalToMint,"Oopps try again");
        require(block.timestamp.sub(timeMintedLast)>=10 seconds, "wait for the 1 year cycle ");
